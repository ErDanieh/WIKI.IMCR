...
*Speeded Up Robust Features* es similar a SIFT en que es invariante a cambios de escala y rotación. Utiliza también histogramas de orientación de gradientes. Es más rápido debido a que utiliza aproximaciones a los cálculos de gradientes y cálculos de determinantes de matrices hessianas.

Para refrescar, una matriz hessiana es una matriz cuadrada de segundas derivadas parciales de una función escalar. En este contexto se utiliza para analizar la estructura local de la imagen en un punto de interés.

### ORB

*Oriented FAST and Rotated BRIEF* realiza una combinación de características de detección y descripción. Utiliza el algoritmo de detección de puntos clave FAST para detectar puntos de interés, y luego utiliza el descriptor BRIEF para describir las características locales en una imagen. ORB también es invariante a cambios de escala y rotación.

### BRISK

*Binary Robust Invariant Scalable Keypoints* es una versión mejorada y más rápida de ORB, y utiliza la misma estrategia de detección y descripción. BRISK utiliza una aproximación binaria para la descripción de características, lo que reduce el tamaño del descriptor y aumenta la eficiencia. Robusto frente a cambios de escala.

## Práctica.

Vamos a ver cómo podemos usar nosotros estos descriptores para nuestro beneficio. Deberemos tener MATLAB para poder llevar a cabo este ejemplo introductorio y los *Add-Ons* de visión por computador y procesado de imágenes.
...
![image](Images/ImagenesDescriptores/variable_puntos_objeto.png)

**puntos_contexto = detectSIFTFeatures(contexto);**

![image](Images/ImagenesDescriptores/variable_puntos_contexto.png)
...
![image](Images/ImagenesDescriptores/puntos_emparejados_objeto.png)
...
![image](Images/ImagenesDescriptores/puntos_emparejados_surf.png)

#### ORB

![image](Images/ImagenesDescriptores/puntos_emparejados_orb.png)

#### BRISK

![image](Images/ImagenesDescriptores/puntos_emparejados_brisk.png)

### Observaciones.

Es importante destacar que la calidad importa. Aplicando ORB y BRISK hemos visto que no se han obtenido puntos. A continucación, observamos, con una comparación, lo que ocurre si tenemos las mismas imágenes pero con distinta calidad.

![image](Images/ImagenesDescriptores/puntos_emparejados_brisk.png)
![image](Images/ImagenesDescriptores/puntos_emparejados_brisk_2.png)
